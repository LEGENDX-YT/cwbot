...
bot = Client(
    "CW",
    bot_token=os.environ.get("BOT_TOKEN", "5602812323:AAHNrfac3x7uq6usroZKWhSBAkJAdnl21j4"),
    api_id=int(os.environ.get("API_ID", "26183094")),
    api_hash=os.environ.get("API_HASH", "07005fb2780934955b3b6e9084817453")
)
